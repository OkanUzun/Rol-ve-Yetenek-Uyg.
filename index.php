  ...
  <div class="container">
    <nav class="navbar navbar-light bg-faded">
      <ul class="nav navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link" href="user-detail.php">Kullanıcı Detay</a></li>
        <li class="nav-item"><a class="nav-link" href="department-create.php">Departmanlar</a></li>
        <li class="nav-item"><a class="nav-link" href="unit-create.php">Birimler</a></li>
        <li class="nav-item"><a class="nav-link" href="role-create.php">Roller</a></li>
        <li class="nav-item"><a class="nav-link" href="ability-create.php">Yetenekler</a></li>
