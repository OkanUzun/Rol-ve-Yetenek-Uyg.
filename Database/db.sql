...
AS
BEGIN
    UPDATE T_EDUCATION SET EDUCATION_SUBJECT = edu_subject, EDUCATION_CONTENT = edu_content, PLANNED_DATE = TO_DATE(planned_dte,'DD/MM/YYYY HH24:MI'), COMPLETE_DATE = TO_DATE(complete_dte,'DD/MM/YYYY HH24:MI'), LOUNGE_FK = lounge_id WHERE PK = edu_id;
    is_valid := '1';
END;
/
