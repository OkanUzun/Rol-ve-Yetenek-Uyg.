CREATE USER roleaby
  IDENTIFIED BY roleaby123;

GRANT ALL PRIVILEGES TO roleaby;  
...
CREATE SEQUENCE ROLEABY.SEQ_USER_PK
  ...
  NOKEEP
  GLOBAL;
DROP TYPE ROLEABY.INT_ARRAY;

CREATE OR REPLACE TYPE ROLEABY."INT_ARRAY" AS VARRAY(50) OF INTEGER;
/
...
ALTER TABLE ROLEABY.CUSTOMERS MODIFY 
  ID NULL;
...
ALTER TABLE ROLEABY.CUSTOMERS
  DROP CONSTRAINT SYS_C0015219;
...
ALTER TABLE ROLEABY.CUSTOMERS ADD (
  PRIMARY KEY
  (ID)
  ENABLE VALIDATE);
...
ALTER TABLE ROLEABY.T_ABILITY
  DROP CONSTRAINT SYS_C0015191;

ALTER TABLE ROLEABY.T_ABILITY
  DROP CONSTRAINT SYS_C0015192;
...
ALTER TABLE ROLEABY.T_ABILITY_LEVEL
  DROP CONSTRAINT SYS_C0015193;

ALTER TABLE ROLEABY.T_ABILITY_LEVEL
  DROP CONSTRAINT SYS_C0015194;
...
ALTER TABLE ROLEABY.T_DEPARTMENT
  DROP CONSTRAINT SYS_C0015195;

ALTER TABLE ROLEABY.T_DEPARTMENT
  DROP CONSTRAINT SYS_C0015196;
...
ALTER TABLE ROLEABY.T_ROLE
  DROP CONSTRAINT SYS_C0015201;

ALTER TABLE ROLEABY.T_ROLE
  DROP CONSTRAINT SYS_C0015202;
...
ALTER TABLE ROLEABY.T_STATE
  DROP CONSTRAINT SYS_C0015203;

ALTER TABLE ROLEABY.T_STATE
  DROP CONSTRAINT SYS_C0015204;
...
ALTER TABLE ROLEABY.T_UNIT
  DROP CONSTRAINT SYS_C0015205;

ALTER TABLE ROLEABY.T_UNIT
  DROP CONSTRAINT SYS_C0015206;
...
INSERT INTO T_STATE(STATE_NAME,STATE_ORDER) VALUES('PLANLANDI',1);
INSERT INTO T_STATE(STATE_NAME,STATE_ORDER) VALUES('BAŞLADI',2);
INSERT INTO T_STATE(STATE_NAME,STATE_ORDER) VALUES('TAMAMLANDI',3);
INSERT INTO T_STATE(STATE_NAME,STATE_ORDER) VALUES('İPTAL EDİLDİ',4);
