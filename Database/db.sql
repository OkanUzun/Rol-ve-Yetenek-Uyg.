...
AS
BEGIN
    UPDATE T_EDUCATION SET CURRENT_STATE = 'İPTAL EDİLDİ' WHERE PK = edu_id;
    INSERT INTO T_EDUCATION_STATE_REL(STATE_ID,EDUCATION_ID) VALUES(3,edu_id);
    is_valid := '1';    
END;
/
...
AS
BEGIN
    UPDATE T_EDUCATION SET CURRENT_STATE = 'SONA ERDİ' WHERE PK = edu_id; 
    INSERT INTO T_EDUCATION_STATE_REL(STATE_ID,EDUCATION_ID) VALUES(2,edu_id);
    is_valid := '1';
END;
/
...
/* Formatted on 31/12/2016 00:47:51 (QP5 v5.287) */
