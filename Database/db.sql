...
(
  ...
  ALLOW_TO_CANCEL                CHAR(1 BYTE)   NOT NULL,
  ALLOW_TO_TERMINATE             CHAR(1 BYTE)   NOT NULL,
  ALLOW_TO_CHANGE_USER_OR_ABLYT  CHAR(1 BYTE)   NOT NULL,
  ALLOW_TO_ACTIVITE              CHAR(1 BYTE)   NOT NULL,
  ALLOW_TO_START                 CHAR(1 BYTE)   NOT NULL,
  ALLOW_TO_CHANGE_DETAILS        CHAR(1 BYTE)   NOT NULL
)
TABLESPACE SYSTEM
PCTUSED    40
PCTFREE    10
...
(
  ...
  U_PW           VARCHAR2(128 BYTE)             NOT NULL,
...
(
  ...
  STATE_FK           INTEGER                    DEFAULT 1                     NOT NULL,
...
ALTER TABLE ROLEABY.T_EDUCATION ADD (
  ...
  ENABLE VALIDATE,
  CONSTRAINT T_EDUCATION_R02 
  FOREIGN KEY (STATE_FK) 
  REFERENCES ROLEABY.T_STATE (PK)
  ENABLE VALIDATE);

ALTER TABLE ROLEABY.T_EDUCATION_ABILITY_REL ADD (
  FOREIGN KEY (EDUCATION_FK) 
  REFERENCES ROLEABY.T_EDUCATION (PK)
  ON DELETE CASCADE
  ENABLE VALIDATE,
  FOREIGN KEY (ABILITY_FK) 
  REFERENCES ROLEABY.T_ABILITY (PK)
...
DROP PROCEDURE ROLEABY.SP_ASSIGN_ABILITY_TO_EDUCATION;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_ASSIGN_ABILITY_TO_EDUCATION(edu_id IN INTEGER,ablyt_id IN INTEGER,is_valid OUT CHAR)
AS
    number_of_ability INTEGER;
BEGIN
    SELECT COUNT(*) INTO number_of_ability FROM T_EDUCATION_ABILITY_REL WHERE EDUCATION_FK = edu_id AND ABILITY_FK = ablyt_id;
    
    IF number_of_ability = 0 THEN
        INSERT INTO T_EDUCATION_ABILITY_REL(EDUCATION_FK,ABILITY_FK) VALUES(edu_id,ablyt_id);
        is_valid:= '1';    
    ELSE
        is_valid:= '0';
    END IF;     
...
DROP PROCEDURE ROLEABY.SP_ASSIGN_ABILITY_TO_USER;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_ASSIGN_ABILITY_TO_USER(usr_id IN INTEGER,ablyt_id IN INTEGER,lvl_id IN INTEGER,is_valid OUT CHAR)
AS
    number_of_ability INTEGER;
BEGIN
    SELECT COUNT(*) INTO number_of_ability FROM T_USER_ABILITY_REL WHERE USER_FK = usr_id AND ABILITY_FK = ablyt_id;
    
    IF number_of_ability = 0 THEN
        INSERT INTO T_USER_ABILITY_REL(USER_FK,ABILITY_FK,ABILITY_LEVEL_FK) VALUES(usr_id,ablyt_id,lvl_id);
        is_valid:= '1';
    ELSE
        is_valid:= '0';
    END IF;        
...
DROP PROCEDURE ROLEABY.SP_ASSIGN_USER_TO_EDUCATION;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_ASSIGN_USER_TO_EDUCATION(edu_id IN INTEGER,usr_id IN INTEGER,is_valid OUT CHAR)
AS
    number_of_user INTEGER;
BEGIN
    SELECT COUNT(*) INTO number_of_user FROM T_EDUCATION_USER_REL WHERE EDUCATION_FK = edu_id AND USER_FK = usr_id;
    
    IF number_of_user = 0 THEN
        INSERT INTO T_EDUCATION_USER_REL(EDUCATION_FK,USER_FK) VALUES(edu_id,usr_id);
        is_valid:= '1';    
    ELSE
        is_valid:= '0';
    END IF;
...
DROP PROCEDURE ROLEABY.SP_CANCEL_EDUCATION;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_CANCEL_EDUCATION(edu_id IN INTEGER,is_valid OUT CHAR)
AS
BEGIN
    UPDATE T_EDUCATION SET STATE_FK = 4 WHERE PK = edu_id;
    is_valid := '1';    
END;
/
...
DROP PROCEDURE ROLEABY.SP_DELETE_ABILITY_FROM_EDU;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_DELETE_ABILITY_FROM_EDU(edu_id IN INTEGER,ablyt_id IN INTEGER,is_valid OUT CHAR)
AS
BEGIN
    DELETE FROM T_EDUCATION_ABILITY_REL WHERE EDUCATION_FK = edu_id AND ABILITY_FK = ablyt_id;
    is_valid:= '1';
END;
/


DROP PROCEDURE ROLEABY.SP_DELETE_ABILITY_FROM_USER;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_DELETE_ABILITY_FROM_USER(usr_id IN INTEGER,ablyt_id IN INTEGER,is_valid OUT CHAR)
AS
BEGIN
    DELETE FROM T_USER_ABILITY_REL WHERE USER_FK = usr_id AND ABILITY_FK = ablyt_id;
    is_valid:= '1';
END;
/


DROP PROCEDURE ROLEABY.SP_DELETE_USER_FROM_EDUCATION;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_DELETE_USER_FROM_EDUCATION(edu_id IN INTEGER,usr_id IN INTEGER,is_valid OUT CHAR)
AS
BEGIN
    DELETE FROM T_EDUCATION_USER_REL WHERE EDUCATION_FK = edu_id AND USER_FK = usr_id;
END;
/


DROP PROCEDURE ROLEABY.SP_REACTIVITE_EDUCATION;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_REACTIVITE_EDUCATION(edu_id IN INTEGER,is_valid OUT CHAR)
AS
BEGIN
      
   UPDATE T_EDUCATION SET STATE_FK = 1 WHERE PK = edu_id;  
    is_valid := '1';
END;
/


DROP PROCEDURE ROLEABY.SP_REFRESH_PASSWORD;

CREATE OR REPLACE PROCEDURE ROLEABY."SP_REFRESH_PASSWORD"(e_mail IN VARCHAR,new_pw IN VARCHAR,is_valid OUT CHAR)
AS
BEGIN
    UPDATE T_USER SET U_PW = new_pw WHERE EMAIL = e_mail;
    is_valid := '1';    
END;
/
...
DROP PROCEDURE ROLEABY.SP_START_EDUCATION;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_START_EDUCATION(edu_id IN INTEGER,is_valid OUT CHAR)
AS
BEGIN
    UPDATE T_EDUCATION SET STATE_FK = 2 WHERE PK = edu_id; 
    is_valid := '1';
END;
/


DROP PROCEDURE ROLEABY.SP_TERMINATE_EDUCATION;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_TERMINATE_EDUCATION(edu_id IN INTEGER,is_valid OUT CHAR)
AS
   CURSOR EDUCATION_PARTICIPANTS IS
     SELECT USER_FK
     FROM T_EDUCATION_USER_REL
     WHERE EDUCATION_FK = edu_id;
     
   CURSOR EDUCATION_ABILITIES IS
     SELECT ABILITY_FK FROM T_EDUCATION_ABILITY_REL
     WHERE EDUCATION_FK = edu_id;
     
   HAVE_ABILITY INTEGER := 0;          
BEGIN
 
   FOR PARTICIPANT IN EDUCATION_PARTICIPANTS LOOP
      FOR ABILITY IN EDUCATION_ABILITIES LOOP
      
        SELECT COUNT(*) INTO HAVE_ABILITY FROM T_USER_ABILITY_REL 
        WHERE T_USER_ABILITY_REL.USER_FK = PARTICIPANT.USER_FK AND 
        T_USER_ABILITY_REL.ABILITY_FK = ABILITY.ABILITY_FK;
        
        IF HAVE_ABILITY = 1 THEN
            UPDATE T_USER_ABILITY_REL SET ABILITY_LEVEL_FK = ABILITY_LEVEL_FK - 1 
            WHERE T_USER_ABILITY_REL.USER_FK = PARTICIPANT.USER_FK AND T_USER_ABILITY_REL.ABILITY_FK = ABILITY.ABILITY_FK
            AND ABILITY_LEVEL_FK > 1;        
        ELSE
            INSERT INTO T_USER_ABILITY_REL(USER_FK,ABILITY_FK,ABILITY_LEVEL_FK) VALUES(PARTICIPANT.USER_FK,ABILITY.ABILITY_FK,3);
        END IF;    

      END LOOP;        
   END LOOP;
      
   UPDATE T_EDUCATION SET STATE_FK = 3 WHERE PK = edu_id;  
    is_valid := '1';
END;
/
...
DROP PROCEDURE ROLEABY.SP_UPDATE_ABILITY_ON_USER;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_UPDATE_ABILITY_ON_USER(usr_id IN INTEGER,ablyt_id IN INTEGER,lvl_id IN INTEGER,is_valid OUT CHAR)
AS
BEGIN
    UPDATE T_USER_ABILITY_REL SET ABILITY_LEVEL_FK = lvl_id WHERE USER_FK = usr_id AND ABILITY_FK = ablyt_id;
    is_valid:= '1';
END;
/
...
DROP PROCEDURE ROLEABY.SP_UPDATE_EDUCATION;

CREATE OR REPLACE PROCEDURE ROLEABY.SP_UPDATE_EDUCATION(edu_id IN INTEGER,edu_subject IN VARCHAR,edu_content IN VARCHAR,edctr_id IN INTEGER, lounge_id IN INTEGER, planned_dte IN VARCHAR, complete_dte IN VARCHAR, is_valid OUT CHAR)
AS
BEGIN
    UPDATE T_EDUCATION SET EDUCATION_SUBJECT = edu_subject, EDUCATION_CONTENT = edu_content, EDUCATOR_FK = edctr_id, PLANNED_DATE = TO_DATE(planned_dte,'DD/MM/YYYY HH24:MI'), COMPLETE_DATE = TO_DATE(complete_dte,'DD/MM/YYYY HH24:MI'), LOUNGE_FK = lounge_id WHERE PK = edu_id;
    is_valid := '1';
END;
/
...
CREATE OR REPLACE PROCEDURE ROLEABY."SP_UPDATE_USER" (usr_id IN INTEGER,e_mail IN VARCHAR,fname IN VARCHAR,lname IN VARCHAR,
    dte_of_birth IN VARCHAR,phne_num IN VARCHAR,addrss IN VARCHAR,is_valid OUT CHAR,rle_id IN INTEGER,
    unt_id IN INTEGER,dep_id IN OUT INTEGER,u_name IN VARCHAR)
AS
    number_of_email INTEGER;
    number_of_phone INTEGER;
    number_of_username INTEGER;
BEGIN
    SELECT COUNT(*) INTO number_of_email FROM T_USER WHERE EMAIL = e_mail AND PK != usr_id;
    SELECT COUNT(*) INTO number_of_phone FROM T_USER WHERE PHONE_NUMBER = phne_num AND PK != usr_id;
    SELECT COUNT(*) INTO number_of_username FROM T_USER WHERE U_ID = u_name AND PK != usr_id;    
...
ALTER TABLE ROLEABY.T_ABILITY
  DROP CONSTRAINT SYS_C0015880;

ALTER TABLE ROLEABY.T_ABILITY
  DROP CONSTRAINT SYS_C0015881;
...
ALTER TABLE ROLEABY.T_ABILITY_LEVEL
  DROP CONSTRAINT SYS_C0015882;

ALTER TABLE ROLEABY.T_ABILITY_LEVEL
  DROP CONSTRAINT SYS_C0015883;
...
ALTER TABLE ROLEABY.T_DEPARTMENT
  DROP CONSTRAINT SYS_C0015884;

ALTER TABLE ROLEABY.T_DEPARTMENT
  DROP CONSTRAINT SYS_C0015885;
...
ALTER TABLE ROLEABY.T_EDUCATION
  DROP CONSTRAINT T_EDUCATION_R02;
...
ALTER TABLE ROLEABY.T_EDUCATION_ABILITY_REL
  DROP CONSTRAINT SYS_C0016016;

ALTER TABLE ROLEABY.T_EDUCATION_ABILITY_REL
  DROP CONSTRAINT SYS_C0016017;
...
ALTER TABLE ROLEABY.T_EDUCATION_USER_REL
  DROP CONSTRAINT SYS_C0016014;

ALTER TABLE ROLEABY.T_EDUCATION_USER_REL
  DROP CONSTRAINT SYS_C0016015;
...
ALTER TABLE ROLEABY.T_ROLE
  DROP CONSTRAINT SYS_C0015891;

ALTER TABLE ROLEABY.T_ROLE
  DROP CONSTRAINT SYS_C0015892;
...
ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_CANCEL NULL;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_TERMINATE NULL;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_CHANGE_USER_OR_ABLYT NULL;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_ACTIVITE NULL;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_START NULL;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_CHANGE_DETAILS NULL;

ALTER TABLE ROLEABY.T_STATE
  DROP CONSTRAINT SYS_C0015893;

ALTER TABLE ROLEABY.T_STATE
  DROP CONSTRAINT SYS_C0015894;
...
ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_CANCEL NOT NULL
  ENABLE VALIDATE;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_TERMINATE NOT NULL
  ENABLE VALIDATE;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_CHANGE_USER_OR_ABLYT NOT NULL
  ENABLE VALIDATE;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_ACTIVITE NOT NULL
  ENABLE VALIDATE;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_START NOT NULL
  ENABLE VALIDATE;

ALTER TABLE ROLEABY.T_STATE MODIFY 
  ALLOW_TO_CHANGE_DETAILS NOT NULL
  ENABLE VALIDATE;
...
ALTER TABLE ROLEABY.T_UNIT
  DROP CONSTRAINT SYS_C0015895;

ALTER TABLE ROLEABY.T_UNIT
  DROP CONSTRAINT SYS_C0015896;
...
ALTER TABLE ROLEABY.T_USER_ABILITY_REL
  DROP CONSTRAINT SYS_C0016018;

ALTER TABLE ROLEABY.T_USER_ABILITY_REL
  DROP CONSTRAINT SYS_C0016019;
...
ALTER TABLE ROLEABY.T_USER_ABILITY_REL ADD (
  ...
  ON DELETE CASCADE
  ENABLE VALIDATE);
DROP VIEW ROLEABY.V_ABILITIES;

/* Formatted on 6/1/2017 21:59:37 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_ABILITIES
(
   PK,
   ABILITY_NAME,
   X
...
AS
   SELECT T_ABILITY.PK,
          T_ABILITY.ABILITY_NAME,
          (SELECT COUNT (*)
             FROM T_USER_ABILITY_REL
            WHERE T_ABILITY.PK = T_USER_ABILITY_REL.ABILITY_FK)
             AS X
     FROM T_ABILITY;


DROP VIEW ROLEABY.V_DEPARTMENTS;

/* Formatted on 6/1/2017 21:59:37 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_DEPARTMENTS
(
   PK,
   DEP_NAME
)
   BEQUEATH DEFINER
AS
     SELECT PK, INITCAP (DEPARTMENT_NAME) AS DEP_NAME
       FROM T_DEPARTMENT
   ORDER BY DEPARTMENT_NAME;


DROP VIEW ROLEABY.V_DEPARTMENTS_WITH_USER_COUNT;

/* Formatted on 6/1/2017 21:59:37 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_DEPARTMENTS_WITH_USER_COUNT
(
   F_NAME,
   L_NAME,
   PK,
   ...
   BEQUEATH DEFINER
AS
     SELECT INITCAP (K.FIRST_NAME) AS F_NAME,
            UPPER (K.LAST_NAME) AS L_NAME,
            T_DEPARTMENT.PK,
            INITCAP (T_DEPARTMENT.DEPARTMENT_NAME) AS DEP_NAME,
            COUNT (T_USER.PK) AS X
       FROM T_DEPARTMENT
            LEFT JOIN T_USER ON T_USER.DEPARTMENT_FK = T_DEPARTMENT.PK
            LEFT JOIN T_USER K ON T_DEPARTMENT.MANAGER_ID = K.PK
   GROUP BY T_DEPARTMENT.PK,
            T_DEPARTMENT.DEPARTMENT_NAME,
            K.FIRST_NAME,
            K.LAST_NAME
   ORDER BY T_DEPARTMENT.DEPARTMENT_NAME;


DROP VIEW ROLEABY.V_EDUCATIONS;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_EDUCATIONS
(
   PK,
   SUBJECT,
   EDCTR_NAME,
   ...
   BEQUEATH DEFINER
AS
   SELECT T_EDUCATION.PK,
          T_EDUCATION.EDUCATION_SUBJECT AS SUBJECT,
          T_EDUCATOR.EDUCATOR_NAME AS EDCTR_NAME,
          T_EDUCATION.PLANNED_DATE AS PLND_DTE,
          T_EDUCATION.COMPLETE_DATE AS CMPLT_DTE,
          INITCAP (T_STATE.STATE_NAME) AS CRR_STT,
          INITCAP (T_LOUNGE.LOUNGE_NAME) AS LNG_NAME
     FROM T_LOUNGE,
          T_STATE,
          T_EDUCATION
          LEFT JOIN T_EDUCATOR ON T_EDUCATION.EDUCATOR_FK = T_EDUCATOR.PK
    WHERE     T_EDUCATION.LOUNGE_FK = T_LOUNGE.PK
          AND T_STATE.PK = T_EDUCATION.STATE_FK;


DROP VIEW ROLEABY.V_EDUCATORS;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_EDUCATORS
(
   PK,
   EDUCATOR_NAME,
   IS_INHOUSE,
...
DROP VIEW ROLEABY.V_EDUCATORS_WITH_INHOUSE_INFO;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_EDUCATORS_WITH_INHOUSE_INFO
(
   PK,
   EDUCATOR_NAME,
   IS_INHOUSE,
   ...
   BEQUEATH DEFINER
AS
     SELECT T_EDUCATOR.PK,
            T_EDUCATOR.EDUCATOR_NAME,
            T_EDUCATOR.IS_INHOUSE,
            INITCAP (T_ROLE.ROLE_NAME) AS RLE_NAME
       FROM T_EDUCATOR
...
DROP VIEW ROLEABY.V_LOUNGES;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_LOUNGES
(
   PK,
   LNG_NAME
)
   BEQUEATH DEFINER
AS
     SELECT PK, INITCAP (LOUNGE_NAME) AS LNG_NAME
       FROM T_LOUNGE
   ORDER BY LNG_NAME;


DROP VIEW ROLEABY.V_ROLES;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_ROLES
(
   PK,
   RLE_NAME
)
   BEQUEATH DEFINER
AS
     SELECT PK, INITCAP (ROLE_NAME) AS RLE_NAME
       FROM T_ROLE
   ORDER BY ROLE_NAME;


DROP VIEW ROLEABY.V_ROLES_WITH_USER_COUNT;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_ROLES_WITH_USER_COUNT
(
   PK,
   RLE_NAME,
   X
...
AS
     SELECT T_ROLE.PK,
            INITCAP (T_ROLE.ROLE_NAME) AS RLE_NAME,
            COUNT (T_USER.PK) AS X
       FROM T_ROLE LEFT JOIN T_USER ON T_USER.ROLE_FK = T_ROLE.PK
   GROUP BY T_ROLE.PK, T_ROLE.ROLE_NAME
   ORDER BY T_ROLE.ROLE_NAME;


DROP VIEW ROLEABY.V_UNITS;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_UNITS
(
   PK,
   UNT_NAME
)
   BEQUEATH DEFINER
AS
     SELECT PK, INITCAP (UNIT_NAME) AS UNT_NAME
       FROM T_UNIT
   ORDER BY UNIT_NAME;


DROP VIEW ROLEABY.V_UNITS_BY_DEPARTMENTS;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_UNITS_BY_DEPARTMENTS
(
   F_NAME,
   L_NAME,
   PK,
...
AS
     SELECT INITCAP (K.FIRST_NAME) AS F_NAME,
            UPPER (K.LAST_NAME) AS L_NAME,
            T_UNIT.PK AS PK,
            INITCAP (T_UNIT.UNIT_NAME) AS UNT_NAME,
            INITCAP (T_DEPARTMENT.DEPARTMENT_NAME) AS DEP_NAME,
            COUNT (T_USER.PK) AS X
       FROM T_UNIT
            INNER JOIN T_DEPARTMENT ON T_UNIT.DEPARTMENT_FK = T_DEPARTMENT.PK
            LEFT JOIN T_USER ON T_UNIT.PK = T_USER.UNIT_FK
            LEFT JOIN T_USER K ON T_UNIT.MANAGER_ID = K.PK
   GROUP BY T_UNIT.PK,
            T_UNIT.UNIT_NAME,
            T_DEPARTMENT.DEPARTMENT_NAME,
            K.FIRST_NAME,
            K.LAST_NAME
   ORDER BY DEP_NAME ASC, UNT_NAME;


DROP VIEW ROLEABY.V_USERS;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_USERS
(
   PK,
   F_NAME,
   L_NAME,
...
DROP VIEW ROLEABY.V_USERS_WITH_ROLE;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_USERS_WITH_ROLE
(
   PK,
   F_NAME,
   L_NAME,
...
AS
   SELECT USR.PK,
          INITCAP (USR.FIRST_NAME) AS F_NAME,
          UPPER (USR.LAST_NAME) AS L_NAME,
          INITCAP (RLE.ROLE_NAME) AS RLE_NAME
     FROM T_USER USR LEFT JOIN T_ROLE RLE ON RLE.PK = USR.ROLE_FK;


DROP VIEW ROLEABY.V_USER_F_L_NAME;

/* Formatted on 6/1/2017 21:59:38 (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW ROLEABY.V_USER_F_L_NAME
(
   PK,
   F_NAME,
   L_NAME
