...
CREATE OR REPLACE PROCEDURE SYSTEM.SP_CREATE_USER(usr_id IN VARCHAR,u_pw IN VARCHAR,e_mail IN VARCHAR,fname IN VARCHAR,lname IN VARCHAR,
...
BEGIN
    ...
    IF number_of_user = 0 AND number_of_email = 0 AND number_of_phone = 0 THEN
        INSERT INTO T_USER(U_ID,U_PW,FIRST_NAME,LAST_NAME,DATE_OF_BIRTH,PHONE_NUMBER,ADDRESS,EMAIL) 
            VALUES(usr_id,u_pw,fname,lname,dte_of_birth,phne_num,addrss,e_mail);
